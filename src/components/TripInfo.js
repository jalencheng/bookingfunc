    ...
    <View style={[styles.cardView, {
        ...
        <View style={styles.itineraryandLocation}>
            ...
            <View style={styles.timestext}>
                ...
                <Text style={styles.timeSubText}>Direct</Text>
            </View>
            <View>
                <Pressable style={styles.selectButton} onPress={props.onPress}><Text style={styles.selectButtonText}>Book</Text></Pressable>
            </View>
        </View> 
