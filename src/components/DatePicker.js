      ...
      <Pressable style={styles.containerRound} onPress={ () => {
        ...
        <View style={styles.headerRound}>
          ...
          <View style={styles.calendarData}>
            ...
            <Text style={styles.headerText}>{Months[props.startDate.getMonth()]}</Text>
        ...
        <View style={styles.subheaderRound}>
          ...
          <View style={styles.calendarData}>
            ...
            <Text style={styles.headerText}>{props.endDate ? Months[props.endDate.getMonth()] : Months[tomorrow.getMonth()] }</Text>
