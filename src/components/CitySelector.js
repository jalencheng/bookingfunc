  ...
  return (
    <View>
        <Pressable style={styles.container} onPress = {props.onPress}>
            ...
            <Text style={styles.fromText}>{props.selectorType == 'Arrival' ? props.destinationPoint.name ? props.destinationPoint.name : 'Arrival' : props.originPoint.name ? props.originPoint.name : props.selectorType}</Text>
        </Pressable>
    </View>
  )
}
